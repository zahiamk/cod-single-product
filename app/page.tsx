        ...
        <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-[1fr_460px] md:items-center">
          ...
          <div className="rounded-[2rem] bg-white p-6 text-black shadow-2xl md:p-8">
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <button type="submit" disabled={isSubmitting} className="w-full rounded-xl bg-[#c65b32] py-4 font-black text-white transition hover:bg-[#ad4e2b] disabled:cursor-not-allowed disabled:opacity-70" > {isSubmitting ? "⏳ جارٍ إرسال الطلب..." : "🛒 تأكيد طلبي"} </button> <p className="text-center text-xs text-black/40"> الدفع عند الاستلام · لا يوجد دفع بالبطاقة </p>
